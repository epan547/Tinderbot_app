...
def give_pickup_lines(key_word,all_dicts,num_lines_weight = 2,num_lines_random = 1):
    """
    Inputs:
    ...
    if category_dict == False:
        trigger_words = get_trigger_words(related_words,key_word)
...
def main(key_word):
    all_dicts = initialize_all_dicts()
    list_and_cat = give_pickup_lines(key_word,all_dicts)
    return list_and_cat
#
# adjust =1
# key_word = "coffee"
